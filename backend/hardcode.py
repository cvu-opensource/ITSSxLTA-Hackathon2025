...
weather_sensor_mapping = {    
    'TPE': ['S224', 'S220', 'S29', 'S94', 'S81', 'S900'],
    'CTE': ['S109', 'S217', 'S222', 'S79'],
    'BKE': ['S211'],
    'ECP': ['S207', 'S208', 'S107', 'S113', 'S119', 'S214'],
    'AYE': ['S216', 'S201', 'S222', 'S33', 'S71', 'S226', 'S92', 'S230'],
    'PIE': ['S215', 'S201', 'S50', 'S213', 'S229', 'S228', 'S44', 'S84', 'S123'],
    'KJE': ['S64'],
    'SLE': ['S104', 'S227'],
    'KPE': ['S221'],
    'MCE': [],
...
camera_mapping = {
    ...
    'BKE': [2703, 2705, 2706, 2707, 2708],
    'ECP': [1001, 3702, 3704, 3705, 3793, 3795, 3796, 3797, 3798],
    'AYE': [4701, 4702, 4704, 4705, 4706, 4707, 4708, 4709, 4710, 4712, 4714, 4716],
    'PIE': [1002, 1003, 1004, 1004, 5794, 5795, 5797, 5798, 5799, 6701, 6703, 6704, 6704, 6705, 6706, 6708, 6710, 6711, 6712, 6713, 6714, 6715, 6716],
